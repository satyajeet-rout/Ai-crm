...
// import { Search, Plus, Filter, ArrowUpDown, Home, Users, Bell, CheckSquare, FileText, Settings, Link, ArrowLeft, Mail, Phone, MapPin, Calendar, Edit, Trash2, Star, Clock, Mic, Send } from 'lucide-react';
...
//   const groups = [
//     { name: "Close friends", count: 37, icon: "👥", color: "text-yellow-600" },
//     { name: "Startup founder", count: 142, icon: "👔", color: "text-yellow-600" },
//     { name: "Investor", count: 28, icon: "💰", color: "text-yellow-600" },
//     { name: "Product Hunt", count: 296, icon: "🚀", color: "text-orange-600" },
//     { name: "Tech Crunch", count: 15, icon: "🚀", color: "text-orange-600" },
//     { name: "Barcelona", count: 8, icon: "🏛️", color: "text-orange-600" },
//     { name: "Dinner party", count: 23, icon: "🍽️", color: "text-orange-600" }
//   ];
...
//         {/* Groups */}
//         {/* <div className="mt-8">
//           <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Groups</h3>
//           <div className="space-y-1">
//             {groups.map((group, index) => (
//               <button
//                 key={index}
//                 className="w-full flex items-center justify-between px-3 py-1 text-gray-700 hover:bg-gray-100 rounded-lg"
//               >
...
// //             <div className="text-sm text-gray-500 font-medium mb-3 mt-6">
// //               {getSectionTitle(section)}
// //             </div>
// //           )}
...
// //               className="px-6 py-4 hover:bg-gray-50 border-b border-gray-100 cursor-pointer"
// //             >
...
// //                   <span>{getGroupIcon(contact.group)}</span>
// //                   <span className="text-gray-700 text-sm">{contact.group}</span>
// //                 </div>

// //                 {/* Company Column */}
// //                 <div className="col-span-3 flex items-center space-x-2">
// //                   <span>{contact.companyIcon}</span>
...
// //             <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded-full text-sm">729</span>
// //           </div>
// //           <div className="flex items-center space-x-3">
